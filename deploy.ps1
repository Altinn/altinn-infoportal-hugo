param([string]$GitToken = "", [string]$OrgName = "altinnbeta", [string]$RepoName = "altinn-infoportal", [string]$UserEmail = "", [string]$UserName = "", [int]$RunTidy = 0)

cd ..
git clone https://dev.azure.com/brreg/altinn-infoportal/_git/$RepoName-site 
cd $PSScriptRoot
